...
// the class is static, because we do not have to create an instance of the class;
// this is static data that we can access
public static class Data
{
    // inputing all of the coordinates for the cells:
    ...
    // for our data we are using dictionary:
    // the dictionary is key-value-pairing
    // in this case, the key is the tetromino array 
    // and the values are the cells
    // we need this in order to assign the values to the tetrominoData in the tetromino script
    // so for every key, we specify the array of cells associated with that
